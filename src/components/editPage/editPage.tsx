    ...
    return (
        ...
        <div className="flex flex-row *:min-w-[45vw]">
            ...
            <div className="w-full max-w-[40rem] p-2">
                ...
                {(
                    <Image
                        src={form.watch("image") instanceof File ? URL.createObjectURL(form.watch("image") as Blob) : typeof form.watch("image") === "string" ? form.watch("image") as string : "/fallback.svg"}
                        width={500}
                        height={500}
                        alt="Recipe image"
