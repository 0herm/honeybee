        ...
        <>
            <html lang='en' className={`${theme}`}>
                ...
                <body className='w-screen h-screen bg-background text-foreground flex flex-col m-0 p-0 font-[family-name:Inter] antialiased align-middle break-words leading-[1.5] tracking-normal'>
                    <nav className='fixed top-[-10px] pt-[10px] h-[3rem] w-full border-solid border-b border-accent backdrop-blur-md z-50 print:hidden'>
                        <NavBar />
                    </nav>
                    <main className='w-full flex grow p-5 pt-20 print:pt-0'>
                        {children}
                    </main>
